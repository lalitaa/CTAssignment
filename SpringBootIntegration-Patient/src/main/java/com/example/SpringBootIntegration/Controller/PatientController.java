...
public class PatientController {
	...
	@PostMapping("/getfrompatientname")
	public Patient getfrompatientname(@RequestBody Patient patient)
	{
		Patient patientbean = patientservice.getfrompatientname(patient);
		return patientbean;
	}
